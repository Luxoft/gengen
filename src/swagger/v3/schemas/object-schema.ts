...
export type IOpenAPI3ObjectPropertySchema = IOpenAPI3SimpleSchema | IOpenAPI3ArraySchema | IOpenAPI3Reference | IOpenAPI3AllOfSchema;

export interface IOpenAPI3ObjectSchema extends IOpenAPI3BaseSchema {
    type: 'object';
    properties: {
        [key: string]: IOpenAPI3ObjectPropertySchema;
    };
}
